...
# Random powerup spawn timing (25–45 sec)
...
ammo_powerup_surf = pygame.image.load(join('images', 'ammo_powerup.png')).convert_alpha()  # Powerup image
...
def collisions():
    ...
    if collision_sprites:
        # For each meteor that hit us, lose 1 health
...
# ---------------------------
def display_score():
    # This uses the time (in ms) plus any meteor kills
    current_time = pygame.time.get_ticks()
...
while running:
    ...
    # 6) Draw Health Bar (under the player)
